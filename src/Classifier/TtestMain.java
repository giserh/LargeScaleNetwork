...
public class TtestMain  {
	static public void main(String[] args) throws IOException, ParseException {
		...
		//Feture selection.
			...
			analyzer.LoadDoc(param.m_folder);
		...
		if (param.m_style.equals("SUP")) {
			...
			System.out.println(param.m_folder);
			model.crossValidation2(param.m_CVFold, corpus);
			model.crossValidation3(0.0, 0.8, corpus);
			model.crossValidation3(0.2, 1.0, corpus);
