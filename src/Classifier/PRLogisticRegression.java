...
public class PRLogisticRegression extends BaseClassifier {
	...
	public PRLogisticRegression(_Corpus c, int classNo, int featureSize){
	...
	private double calcFuncGradient(Collection<_Doc> trainSet) {
		...
		for (_Doc doc: trainSet) {
			...
			double tmp_pij[] = new double [m_classNo];
			double pr_pij[] = new double [m_classNo];
